<template>
  <div class="container">
    ...
    <!-- <cpagination :child-msg="page" @callFather="callFather"></cpagination> -->
  </div>
</template>
  ...
  data () {
    return {
      ...
      searchInput: [
        ...
        { name: '合同号', value: '3', label: 'contractNo', type: 'input' },
        { name: '签约时间', value: '4', label: 'signTime', type: 'daterange' }
      ],
      data: [],
      page: {
        pageSize: 5,
